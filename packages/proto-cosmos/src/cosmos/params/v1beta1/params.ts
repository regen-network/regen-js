...
const baseParameterChangeProposal: object = {
  title: "",
  description: "",
};

const baseParamChange: object = {
  subspace: "",
  key: "",
  value: "",
};
...
export const ParameterChangeProposal = {
  encode(message: ParameterChangeProposal, writer: Writer = Writer.create()): Writer {
...
export const ParamChange = {
  ...
  decode(input: Uint8Array | Reader, length?: number): ParamChange {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
