...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    cosmos: {
        app: {
            v1alpha1: {
                config(request?: import("./app/v1alpha1/query").QueryConfigRequest | undefined): Promise<import("./app/v1alpha1/query").QueryConfigResponse>;
            };
        };
        auth: {
            v1beta1: {
                accounts(request?: import("./auth/v1beta1/query").QueryAccountsRequest | undefined): Promise<import("./auth/v1beta1/query").QueryAccountsResponse>;
                ...
                params(request?: import("./auth/v1beta1/query").QueryParamsRequest | undefined): Promise<import("./auth/v1beta1/query").QueryParamsResponse>;
                moduleAccounts(request?: import("./auth/v1beta1/query").QueryModuleAccountsRequest | undefined): Promise<import("./auth/v1beta1/query").QueryModuleAccountsResponse>;
                ...
                bech32Prefix(request?: import("./auth/v1beta1/query").Bech32PrefixRequest | undefined): Promise<import("./auth/v1beta1/query").Bech32PrefixResponse>;
        ...
        bank: {
            v1beta1: {
                ...
                totalSupply(request?: import("./bank/v1beta1/query").QueryTotalSupplyRequest | undefined): Promise<import("./bank/v1beta1/query").QueryTotalSupplyResponse>;
                supplyOf(request: import("./bank/v1beta1/query").QuerySupplyOfRequest): Promise<import("./bank/v1beta1/query").QuerySupplyOfResponse>;
                params(request?: import("./bank/v1beta1/query").QueryParamsRequest | undefined): Promise<import("./bank/v1beta1/query").QueryParamsResponse>;
                ...
                denomsMetadata(request?: import("./bank/v1beta1/query").QueryDenomsMetadataRequest | undefined): Promise<import("./bank/v1beta1/query").QueryDenomsMetadataResponse>;
        ...
        base: {
            node: {
                v1beta1: {
                    config(request?: import("./base/node/v1beta1/query").ConfigRequest | undefined): Promise<import("./base/node/v1beta1/query").ConfigResponse>;
                };
            };
            tendermint: {
                v1beta1: {
                    getNodeInfo(request?: import("./base/tendermint/v1beta1/query").GetNodeInfoRequest | undefined): Promise<import("./base/tendermint/v1beta1/query").GetNodeInfoResponse>;
                    getSyncing(request?: import("./base/tendermint/v1beta1/query").GetSyncingRequest | undefined): Promise<import("./base/tendermint/v1beta1/query").GetSyncingResponse>;
                    getLatestBlock(request?: import("./base/tendermint/v1beta1/query").GetLatestBlockRequest | undefined): Promise<import("./base/tendermint/v1beta1/query").GetLatestBlockResponse>;
                    ...
                    getLatestValidatorSet(request?: import("./base/tendermint/v1beta1/query").GetLatestValidatorSetRequest | undefined): Promise<import("./base/tendermint/v1beta1/query").GetLatestValidatorSetResponse>;
        ...
        distribution: {
            v1beta1: {
                params(request?: import("./distribution/v1beta1/query").QueryParamsRequest | undefined): Promise<import("./distribution/v1beta1/query").QueryParamsResponse>;
                ...
                communityPool(request?: import("./distribution/v1beta1/query").QueryCommunityPoolRequest | undefined): Promise<import("./distribution/v1beta1/query").QueryCommunityPoolResponse>;
            };
        };
        evidence: {
            v1beta1: {
                ...
                allEvidence(request?: import("./evidence/v1beta1/query").QueryAllEvidenceRequest | undefined): Promise<import("./evidence/v1beta1/query").QueryAllEvidenceResponse>;
            };
        };
        feegrant: {
            v1beta1: {
        ...
        mint: {
            v1beta1: {
                params(request?: import("./mint/v1beta1/query").QueryParamsRequest | undefined): Promise<import("./mint/v1beta1/query").QueryParamsResponse>;
                inflation(request?: import("./mint/v1beta1/query").QueryInflationRequest | undefined): Promise<import("./mint/v1beta1/query").QueryInflationResponse>;
                annualProvisions(request?: import("./mint/v1beta1/query").QueryAnnualProvisionsRequest | undefined): Promise<import("./mint/v1beta1/query").QueryAnnualProvisionsResponse>;
            };
        };
        nft: {
            v1beta1: {
                ...
                classes(request?: import("./nft/v1beta1/query").QueryClassesRequest | undefined): Promise<import("./nft/v1beta1/query").QueryClassesResponse>;
            };
        };
        params: {
            v1beta1: {
                params(request: import("./params/v1beta1/query").QueryParamsRequest): Promise<import("./params/v1beta1/query").QueryParamsResponse>;
                subspaces(request?: import("./params/v1beta1/query").QuerySubspacesRequest | undefined): Promise<import("./params/v1beta1/query").QuerySubspacesResponse>;
            };
        };
        slashing: {
            v1beta1: {
                params(request?: import("./slashing/v1beta1/query").QueryParamsRequest | undefined): Promise<import("./slashing/v1beta1/query").QueryParamsResponse>;
                ...
                signingInfos(request?: import("./slashing/v1beta1/query").QuerySigningInfosRequest | undefined): Promise<import("./slashing/v1beta1/query").QuerySigningInfosResponse>;
            };
        };
        staking: {
            v1beta1: {
                ...
                pool(request?: import("./staking/v1beta1/query").QueryPoolRequest | undefined): Promise<import("./staking/v1beta1/query").QueryPoolResponse>;
                params(request?: import("./staking/v1beta1/query").QueryParamsRequest | undefined): Promise<import("./staking/v1beta1/query").QueryParamsResponse>;
            };
        };
        tx: {
            v1beta1: {
        ...
        upgrade: {
            v1beta1: {
                currentPlan(request?: import("./upgrade/v1beta1/query").QueryCurrentPlanRequest | undefined): Promise<import("./upgrade/v1beta1/query").QueryCurrentPlanResponse>;
                ...
                authority(request?: import("./upgrade/v1beta1/query").QueryAuthorityRequest | undefined): Promise<import("./upgrade/v1beta1/query").QueryAuthorityResponse>;
            };
        };
    };
}>;
