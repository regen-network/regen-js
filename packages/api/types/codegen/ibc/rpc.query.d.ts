        ...
        applications: {
            transfer: {
                v1: {
                    ...
                    denomTraces(request?: import("./applications/transfer/v1/query").QueryDenomTracesRequest | undefined): Promise<import("./applications/transfer/v1/query").QueryDenomTracesResponse>;
                    params(request?: import("./applications/transfer/v1/query").QueryParamsRequest | undefined): Promise<import("./applications/transfer/v1/query").QueryParamsResponse>;
        ...
        core: {
            client: {
                v1: {
                    ...
                    clientStates(request?: import("./core/client/v1/query").QueryClientStatesRequest | undefined): Promise<import("./core/client/v1/query").QueryClientStatesResponse>;
                    ...
                    clientParams(request?: import("./core/client/v1/query").QueryClientParamsRequest | undefined): Promise<import("./core/client/v1/query").QueryClientParamsResponse>;
                    upgradedClientState(request?: import("./core/client/v1/query").QueryUpgradedClientStateRequest | undefined): Promise<import("./core/client/v1/query").QueryUpgradedClientStateResponse>;
                    upgradedConsensusState(request?: import("./core/client/v1/query").QueryUpgradedConsensusStateRequest | undefined): Promise<import("./core/client/v1/query").QueryUpgradedConsensusStateResponse>;
                };
            };
        };
    };
