...
const createRPCQueryClient = async ({ rpcEndpoint }) => {
    ...
    return {
        ...
        regen: {
            data: {
                v1: (await Promise.resolve().then(() => __importStar(require("./data/v1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            ecocredit: {
                basket: {
                    v1: (await Promise.resolve().then(() => __importStar(require("./ecocredit/basket/v1/query.rpc.Query")))).createRpcQueryExtension(client)
                },
                marketplace: {
                    v1: (await Promise.resolve().then(() => __importStar(require("./ecocredit/marketplace/v1/query.rpc.Query")))).createRpcQueryExtension(client)
                },
                v1: (await Promise.resolve().then(() => __importStar(require("./ecocredit/v1/query.rpc.Query")))).createRpcQueryExtension(client),
                v1alpha1: (await Promise.resolve().then(() => __importStar(require("./ecocredit/v1alpha1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            intertx: {
                v1: (await Promise.resolve().then(() => __importStar(require("./intertx/v1/query.rpc.Query")))).createRpcQueryExtension(client)
            }
        }
    };
};
