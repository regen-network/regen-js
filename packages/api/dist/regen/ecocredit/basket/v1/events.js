...
exports.EventUpdateDateCriteria = exports.EventUpdateCurator = exports.EventTake = exports.EventPut = exports.EventCreate = void 0;
//@ts-nocheck
...
exports.EventUpdateCurator = {
    ...
    fromAminoMsg(object) {
        return exports.EventUpdateCurator.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.EventUpdateCurator.decode(message.value);
    },
    toProto(message) {
        return exports.EventUpdateCurator.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/regen.ecocredit.basket.v1.EventUpdateCurator",
            value: exports.EventUpdateCurator.encode(message).finish()
        };
    }
};
...
exports.EventUpdateDateCriteria = {
    ...
    fromAminoMsg(object) {
        return exports.EventUpdateDateCriteria.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.EventUpdateDateCriteria.decode(message.value);
    },
    toProto(message) {
        return exports.EventUpdateDateCriteria.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/regen.ecocredit.basket.v1.EventUpdateDateCriteria",
            value: exports.EventUpdateDateCriteria.encode(message).finish()
        };
    }
};
