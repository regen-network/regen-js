...
exports.Market = exports.AllowedDenom = exports.SellOrder = void 0;
//@ts-nocheck
...
exports.SellOrder = {
    ...
    fromAmino(object) {
        ...
        if (object.seller !== undefined && object.seller !== null) {
            message.seller = (0, helpers_1.bytesFromBase64)(object.seller);
        }
    ...
    toAmino(message) {
        ...
        obj.seller = message.seller ? (0, helpers_1.base64FromBytes)(message.seller) : undefined;
    ...
    fromAminoMsg(object) {
        return exports.SellOrder.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.SellOrder.decode(message.value);
    },
    toProto(message) {
        return exports.SellOrder.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/regen.ecocredit.marketplace.v1.SellOrder",
            value: exports.SellOrder.encode(message).finish()
        };
    }
};
