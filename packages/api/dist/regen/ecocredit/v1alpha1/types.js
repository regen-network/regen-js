...
exports.CreditTypeSeq = exports.CreditType = exports.Params = exports.BatchInfo = exports.ClassInfo = void 0;
//@ts-nocheck
...
exports.ClassInfo = {
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.creditType !== undefined) {
            exports.CreditType.encode(message.creditType, writer.uint32(42).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    message.creditType = exports.CreditType.decode(reader, reader.uint32());
                    break;
                case 6:
    ...
    fromPartial(object) {
        ...
        message.creditType = object.creditType !== undefined && object.creditType !== null ? exports.CreditType.fromPartial(object.creditType) : undefined;
    ...
    fromAmino(object) {
        ...
        if (object.credit_type !== undefined && object.credit_type !== null) {
            message.creditType = exports.CreditType.fromAmino(object.credit_type);
        }
    ...
    toAmino(message) {
        ...
        obj.credit_type = message.creditType ? exports.CreditType.toAmino(message.creditType) : undefined;
...
exports.BatchInfo = {
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.startDate !== undefined) {
            timestamp_1.Timestamp.encode((0, helpers_1.toTimestamp)(message.startDate), writer.uint32(58).fork()).ldelim();
        }
        if (message.endDate !== undefined) {
            timestamp_1.Timestamp.encode((0, helpers_1.toTimestamp)(message.endDate), writer.uint32(66).fork()).ldelim();
        }
...
exports.Params = {
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        for (const v of message.creditTypes) {
            exports.CreditType.encode(v, writer.uint32(34).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.creditTypes.push(exports.CreditType.decode(reader, reader.uint32()));
                    break;
                case 5:
                    message.basketCreationFee.push(coin_1.Coin.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromPartial(object) {
        ...
        message.creditTypes = object.creditTypes?.map(e => exports.CreditType.fromPartial(e)) || [];
        message.basketCreationFee = object.basketCreationFee?.map(e => coin_1.Coin.fromPartial(e)) || [];
        return message;
    },
    fromAmino(object) {
        const message = createBaseParams();
        ...
        message.creditTypes = object.credit_types?.map(e => exports.CreditType.fromAmino(e)) || [];
        message.basketCreationFee = object.basket_creation_fee?.map(e => coin_1.Coin.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        ...
        if (message.creditTypes) {
            obj.credit_types = message.creditTypes.map(e => e ? exports.CreditType.toAmino(e) : undefined);
        }
        else {
            obj.credit_types = message.creditTypes;
        }
        if (message.basketCreationFee) {
            obj.basket_creation_fee = message.basketCreationFee.map(e => e ? coin_1.Coin.toAmino(e) : undefined);
        }
        else {
...
exports.CreditTypeSeq = {
    ...
    fromAminoMsg(object) {
        return exports.CreditTypeSeq.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.CreditTypeSeq.decode(message.value);
    },
    toProto(message) {
        return exports.CreditTypeSeq.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/regen.ecocredit.v1alpha1.CreditTypeSeq",
            value: exports.CreditTypeSeq.encode(message).finish()
        };
    }
};
