...
exports.EventCancel = exports.EventRetire = exports.EventReceive = exports.EventCreateBatch = exports.EventCreateClass = void 0;
//@ts-nocheck
...
exports.EventReceive = {
    ...
    fromAminoMsg(object) {
        return exports.EventReceive.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.EventReceive.decode(message.value);
    },
    toProto(message) {
        return exports.EventReceive.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/regen.ecocredit.v1alpha1.EventReceive",
            value: exports.EventReceive.encode(message).finish()
        };
    }
};
