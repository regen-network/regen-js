...
const createRPCMsgClient = async ({ rpc }) => ({
    ...
    regen: {
        data: {
            v1: new (await Promise.resolve().then(() => __importStar(require("./data/v1/tx.rpc.msg")))).MsgClientImpl(rpc)
        },
        ecocredit: {
            basket: {
                v1: new (await Promise.resolve().then(() => __importStar(require("./ecocredit/basket/v1/tx.rpc.msg")))).MsgClientImpl(rpc)
            },
            marketplace: {
                v1: new (await Promise.resolve().then(() => __importStar(require("./ecocredit/marketplace/v1/tx.rpc.msg")))).MsgClientImpl(rpc)
            },
            v1: new (await Promise.resolve().then(() => __importStar(require("./ecocredit/v1/tx.rpc.msg")))).MsgClientImpl(rpc),
            v1alpha1: new (await Promise.resolve().then(() => __importStar(require("./ecocredit/v1alpha1/tx.rpc.msg")))).MsgClientImpl(rpc)
        },
        intertx: {
            v1: new (await Promise.resolve().then(() => __importStar(require("./intertx/v1/tx.rpc.msg")))).MsgClientImpl(rpc)
        }
    }
});
