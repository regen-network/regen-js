...
export interface TableDescriptorProtoMsg {
  typeUrl: "/regen.orm.v1.TableDescriptor";
  value: Uint8Array;
}
/** TableDescriptor describes an ORM table. */
...
export interface TableDescriptorAminoMsg {
  type: "/regen.orm.v1.TableDescriptor";
...
export interface PrimaryKeyDescriptorProtoMsg {
  typeUrl: "/regen.orm.v1.PrimaryKeyDescriptor";
  value: Uint8Array;
}
/** PrimaryKeyDescriptor describes a table primary key. */
...
export interface PrimaryKeyDescriptorAminoMsg {
  type: "/regen.orm.v1.PrimaryKeyDescriptor";
...
export interface SecondaryIndexDescriptorAminoMsg {
  type: "/regen.orm.v1.SecondaryIndexDescriptor";
...
export interface SingletonDescriptorProtoMsg {
  typeUrl: "/regen.orm.v1.SingletonDescriptor";
  value: Uint8Array;
}
/** TableDescriptor describes an ORM singleton table which has at most one instance. */
...
export interface SingletonDescriptorAminoMsg {
  type: "/regen.orm.v1.SingletonDescriptor";
