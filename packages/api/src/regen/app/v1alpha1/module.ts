...
export interface ModuleDescriptorProtoMsg {
  typeUrl: "/regen.app.v1alpha1.ModuleDescriptor";
  value: Uint8Array;
}
/** ModuleDescriptor describes an app module. */
...
export interface ModuleDescriptorAminoMsg {
  type: "/regen.app.v1alpha1.ModuleDescriptor";
...
export interface PackageReferenceProtoMsg {
  typeUrl: "/regen.app.v1alpha1.PackageReference";
  value: Uint8Array;
}
/** PackageReference is a reference to a protobuf package used by a module. */
...
export interface PackageReferenceAminoMsg {
  type: "/regen.app.v1alpha1.PackageReference";
...
export interface MigrateFromInfoProtoMsg {
  typeUrl: "/regen.app.v1alpha1.MigrateFromInfo";
  value: Uint8Array;
}
/**
 * MigrateFromInfo is information on a module version that a newer module
...
export interface MigrateFromInfoAminoMsg {
  type: "/regen.app.v1alpha1.MigrateFromInfo";
