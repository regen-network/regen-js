...
export function isAminoMsgCreate(msg: AminoMsg): msg is AminoMsgCreate {
...
let createConverter: AminoConverter = {
    ...
    fromAmino: ({curator, name, description, exponent, disable_auto_retire, credit_type_abbrev, allowed_classes, date_criteria, fee}: AminoMsgCreate['value']): Partial<MsgCreate> => {
        return {
            curator,
            name,
            description,
