...
export function isAminoMsgUpdateProjectMetadata(msg: AminoMsg): msg is AminoMsgUpdateProjectMetadata {
...
let updateProjectMetadata: AminoConverter = {
    ...
    fromAmino: ({admin, project_id, new_metadata}: AminoMsgUpdateProjectMetadata['value']): Partial<MsgUpdateProjectMetadata> => {
        return {
            admin,
