...
export function isAminoMsgUpdateClassIssuers(
  msg: AminoMsg,
): msg is AminoMsgUpdateClassIssuers {
  return msg.type === msgUpdateClassIssuersAminoType;
}

export function updateClassIssuersConverter(): AminoConverter {
  return {
    ...
    fromAmino: ({
      ...
      add_issuers,
      remove_issuers,
    }: AminoMsgUpdateClassIssuers['value']): Partial<MsgUpdateClassIssuers> => {
      return {
        admin,
        classId: class_id,
