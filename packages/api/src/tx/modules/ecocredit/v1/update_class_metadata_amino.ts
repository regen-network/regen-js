...
export function isAminoMsgUpdateClassMetadata(msg: AminoMsg): msg is AminoMsgUpdateClassMetadata {
...
let updateClassMetadataConverter: AminoConverter = {
    ...
    fromAmino: ({admin, class_id, new_metadata}: AminoMsgUpdateClassMetadata['value']): Partial<MsgUpdateClassMetadata> => {
        return {
            admin, 
            classId: class_id,
