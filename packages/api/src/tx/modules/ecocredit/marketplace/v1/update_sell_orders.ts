...
import { MsgUpdateSellOrders, MsgUpdateSellOrders_Update } from "../../../../../generated/regen/ecocredit/marketplace/v1/tx";
...
export function isAminoMsgUpdateSellOrders(msg: AminoMsg): msg is AminoMsgUpdateSellOrders {
...
export let updateSellOrderConverter: AminoConverter = {
    ...
    fromAmino: ({seller, updates}: AminoMsgUpdateSellOrders['value']): Partial<MsgUpdateSellOrders> => {
        return {
            seller,
            updates: updates.map(u => {
                return {
