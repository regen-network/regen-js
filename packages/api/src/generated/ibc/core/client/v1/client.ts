...
function createBaseIdentifiedClientState(): IdentifiedClientState {
  return { $type: "ibc.core.client.v1.IdentifiedClientState", clientId: "", clientState: undefined };
}
...
function createBaseConsensusStateWithHeight(): ConsensusStateWithHeight {
  return { $type: "ibc.core.client.v1.ConsensusStateWithHeight", height: undefined, consensusState: undefined };
}
...
function createBaseClientConsensusStates(): ClientConsensusStates {
  return { $type: "ibc.core.client.v1.ClientConsensusStates", clientId: "", consensusStates: [] };
}
...
function createBaseHeight(): Height {
  return { $type: "ibc.core.client.v1.Height", revisionNumber: Long.UZERO, revisionHeight: Long.UZERO };
}
