...
export const RequestEcho = {
  ...
  fromJSON(object: any): RequestEcho {
    return { $type: RequestEcho.$type, message: isSet(object.message) ? String(object.message) : "" };
  },
...
function createBaseRequestInfo(): RequestInfo {
  return { $type: "tendermint.abci.RequestInfo", version: "", blockVersion: Long.UZERO, p2pVersion: Long.UZERO };
}
...
function createBaseRequestQuery(): RequestQuery {
  return { $type: "tendermint.abci.RequestQuery", data: new Uint8Array(), path: "", height: Long.ZERO, prove: false };
}
...
function createBaseRequestCheckTx(): RequestCheckTx {
  return { $type: "tendermint.abci.RequestCheckTx", tx: new Uint8Array(), type: 0 };
}
...
export const RequestDeliverTx = {
  ...
  fromJSON(object: any): RequestDeliverTx {
    return { $type: RequestDeliverTx.$type, tx: isSet(object.tx) ? bytesFromBase64(object.tx) : new Uint8Array() };
  },
...
export const RequestEndBlock = {
  ...
  fromJSON(object: any): RequestEndBlock {
    return { $type: RequestEndBlock.$type, height: isSet(object.height) ? Long.fromValue(object.height) : Long.ZERO };
  },
...
function createBaseRequestOfferSnapshot(): RequestOfferSnapshot {
  return { $type: "tendermint.abci.RequestOfferSnapshot", snapshot: undefined, appHash: new Uint8Array() };
}
...
function createBaseRequestApplySnapshotChunk(): RequestApplySnapshotChunk {
  return { $type: "tendermint.abci.RequestApplySnapshotChunk", index: 0, chunk: new Uint8Array(), sender: "" };
}
...
export const ResponseException = {
  ...
  fromJSON(object: any): ResponseException {
    return { $type: ResponseException.$type, error: isSet(object.error) ? String(object.error) : "" };
  },
...
export const ResponseEcho = {
  ...
  fromJSON(object: any): ResponseEcho {
    return { $type: ResponseEcho.$type, message: isSet(object.message) ? String(object.message) : "" };
  },
...
function createBaseResponseSetOption(): ResponseSetOption {
  return { $type: "tendermint.abci.ResponseSetOption", code: 0, log: "", info: "" };
}
...
function createBaseResponseCommit(): ResponseCommit {
  return { $type: "tendermint.abci.ResponseCommit", data: new Uint8Array(), retainHeight: Long.ZERO };
}
...
function createBaseResponseLoadSnapshotChunk(): ResponseLoadSnapshotChunk {
  return { $type: "tendermint.abci.ResponseLoadSnapshotChunk", chunk: new Uint8Array() };
}
...
function createBaseResponseApplySnapshotChunk(): ResponseApplySnapshotChunk {
  return { $type: "tendermint.abci.ResponseApplySnapshotChunk", result: 0, refetchChunks: [], rejectSenders: [] };
}
...
function createBaseBlockParams(): BlockParams {
  return { $type: "tendermint.abci.BlockParams", maxBytes: Long.ZERO, maxGas: Long.ZERO };
}
...
function createBaseEventAttribute(): EventAttribute {
  return { $type: "tendermint.abci.EventAttribute", key: new Uint8Array(), value: new Uint8Array(), index: false };
}
...
function createBaseTxResult(): TxResult {
  return { $type: "tendermint.abci.TxResult", height: Long.ZERO, index: 0, tx: new Uint8Array(), result: undefined };
}
...
function createBaseValidator(): Validator {
  return { $type: "tendermint.abci.Validator", address: new Uint8Array(), power: Long.ZERO };
}
...
function createBaseVoteInfo(): VoteInfo {
  return { $type: "tendermint.abci.VoteInfo", validator: undefined, signedLastBlock: false };
}
...
export interface ABCIApplication {
  ...
  BeginBlock(request: DeepPartial<RequestBeginBlock>): Promise<ResponseBeginBlock>;
  EndBlock(request: DeepPartial<RequestEndBlock>): Promise<ResponseEndBlock>;
  ListSnapshots(request: DeepPartial<RequestListSnapshots>): Promise<ResponseListSnapshots>;
  OfferSnapshot(request: DeepPartial<RequestOfferSnapshot>): Promise<ResponseOfferSnapshot>;
  LoadSnapshotChunk(request: DeepPartial<RequestLoadSnapshotChunk>): Promise<ResponseLoadSnapshotChunk>;
  ApplySnapshotChunk(request: DeepPartial<RequestApplySnapshotChunk>): Promise<ResponseApplySnapshotChunk>;
}
