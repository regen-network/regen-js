...
function createBaseProtocolVersion(): ProtocolVersion {
  return { $type: "tendermint.p2p.ProtocolVersion", p2p: Long.UZERO, block: Long.UZERO, app: Long.UZERO };
}
...
function createBaseDefaultNodeInfoOther(): DefaultNodeInfoOther {
  return { $type: "tendermint.p2p.DefaultNodeInfoOther", txIndex: "", rpcAddress: "" };
}
