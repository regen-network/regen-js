...
const baseDefaultNodeInfoOther: object = {
  txIndex: "",
  rpcAddress: "",
};
...
export const DefaultNodeInfo = {
  encode(message: DefaultNodeInfo, writer: Writer = Writer.create()): Writer {
    if (message.protocolVersion !== undefined && message.protocolVersion !== undefined) {
    ...
    if (message.other !== undefined && message.other !== undefined) {
      DefaultNodeInfoOther.encode(message.other, writer.uint32(66).fork()).ldelim();
    }
    return writer;
  },
  decode(input: Uint8Array | Reader, length?: number): DefaultNodeInfo {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DefaultNodeInfoOther = {
  encode(message: DefaultNodeInfoOther, writer: Writer = Writer.create()): Writer {
