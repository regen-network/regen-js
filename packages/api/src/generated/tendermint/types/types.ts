...
function createBasePartSetHeader(): PartSetHeader {
  return { $type: "tendermint.types.PartSetHeader", total: 0, hash: new Uint8Array() };
}
...
function createBasePart(): Part {
  return { $type: "tendermint.types.Part", index: 0, bytes: new Uint8Array(), proof: undefined };
}
...
function createBaseBlockID(): BlockID {
  return { $type: "tendermint.types.BlockID", hash: new Uint8Array(), partSetHeader: undefined };
}
...
export const Data = {
  ...
  fromJSON(object: any): Data {
    return { $type: Data.$type, txs: Array.isArray(object?.txs) ? object.txs.map((e: any) => bytesFromBase64(e)) : [] };
  },
...
function createBaseCommit(): Commit {
  return { $type: "tendermint.types.Commit", height: Long.ZERO, round: 0, blockId: undefined, signatures: [] };
}
...
function createBaseTxProof(): TxProof {
  return { $type: "tendermint.types.TxProof", rootHash: new Uint8Array(), data: new Uint8Array(), proof: undefined };
}
