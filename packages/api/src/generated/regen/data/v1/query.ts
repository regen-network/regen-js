...
export const QueryAnchorByIRIRequest = {
  ...
  fromJSON(object: any): QueryAnchorByIRIRequest {
    return {
      $type: QueryAnchorByIRIRequest.$type,
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAnchorByIRIRequest>, I>>(
    object: I,
  ): QueryAnchorByIRIRequest {
    const message = createBaseQueryAnchorByIRIRequest();
...
export const QueryAnchorByIRIResponse = {
  ...
  fromJSON(object: any): QueryAnchorByIRIResponse {
    return {
      ...
      anchor: isSet(object.anchor)
        ? AnchorInfo.fromJSON(object.anchor)
        : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAnchorByIRIResponse>, I>>(
    object: I,
  ): QueryAnchorByIRIResponse {
    const message = createBaseQueryAnchorByIRIResponse();
    message.anchor =
...
export const QueryAnchorByHashRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAnchorByHashRequest>, I>>(
    object: I,
  ): QueryAnchorByHashRequest {
    const message = createBaseQueryAnchorByHashRequest();
    message.contentHash =
...
export const QueryAnchorByHashResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAnchorByHashResponse>, I>>(
    object: I,
  ): QueryAnchorByHashResponse {
    const message = createBaseQueryAnchorByHashResponse();
    message.anchor =
...
messageTypeRegistry.set(
  QueryAnchorByHashResponse.$type,
  QueryAnchorByHashResponse,
);
...
export const QueryAttestationsByAttestorRequest = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<QueryAttestationsByAttestorRequest>, I>,
  >(object: I): QueryAttestationsByAttestorRequest {
    const message = createBaseQueryAttestationsByAttestorRequest();
...
messageTypeRegistry.set(
  QueryAttestationsByAttestorRequest.$type,
  QueryAttestationsByAttestorRequest,
);
...
export const QueryAttestationsByAttestorResponse = {
      ...
      switch (tag >>> 3) {
        case 1:
          message.attestations.push(
            AttestationInfo.decode(reader, reader.uint32()),
          );
          break;
        case 2:
  ...
  toJSON(message: QueryAttestationsByAttestorResponse): unknown {
    ...
    if (message.attestations) {
      obj.attestations = message.attestations.map(e =>
        e ? AttestationInfo.toJSON(e) : undefined,
      );
    } else {
      obj.attestations = [];
    }
  ...
  fromPartial<
    I extends Exact<DeepPartial<QueryAttestationsByAttestorResponse>, I>,
  >(object: I): QueryAttestationsByAttestorResponse {
    const message = createBaseQueryAttestationsByAttestorResponse();
    message.attestations =
      object.attestations?.map(e => AttestationInfo.fromPartial(e)) || [];
    message.pagination =
      object.pagination !== undefined && object.pagination !== null
...
messageTypeRegistry.set(
  QueryAttestationsByAttestorResponse.$type,
  QueryAttestationsByAttestorResponse,
);
...
export const QueryAttestationsByIRIRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAttestationsByIRIRequest>, I>>(
    object: I,
  ): QueryAttestationsByIRIRequest {
    const message = createBaseQueryAttestationsByIRIRequest();
    message.iri = object.iri ?? '';
...
messageTypeRegistry.set(
  QueryAttestationsByIRIRequest.$type,
  QueryAttestationsByIRIRequest,
);
...
export const QueryAttestationsByIRIResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAttestationsByIRIResponse>, I>>(
    object: I,
  ): QueryAttestationsByIRIResponse {
    const message = createBaseQueryAttestationsByIRIResponse();
    message.attestations =
...
messageTypeRegistry.set(
  QueryAttestationsByIRIResponse.$type,
  QueryAttestationsByIRIResponse,
);
...
export const QueryAttestationsByHashRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAttestationsByHashRequest>, I>>(
    object: I,
  ): QueryAttestationsByHashRequest {
    const message = createBaseQueryAttestationsByHashRequest();
    message.contentHash =
...
messageTypeRegistry.set(
  QueryAttestationsByHashRequest.$type,
  QueryAttestationsByHashRequest,
);
...
export const QueryAttestationsByHashResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAttestationsByHashResponse>, I>>(
    object: I,
  ): QueryAttestationsByHashResponse {
    const message = createBaseQueryAttestationsByHashResponse();
    message.attestations =
...
messageTypeRegistry.set(
  QueryAttestationsByHashResponse.$type,
  QueryAttestationsByHashResponse,
);
...
export const QueryResolverRequest = {
  ...
  fromJSON(object: any): QueryResolverRequest {
    return {
      $type: QueryResolverRequest.$type,
  ...
  fromPartial<I extends Exact<DeepPartial<QueryResolverRequest>, I>>(
    object: I,
  ): QueryResolverRequest {
    const message = createBaseQueryResolverRequest();
    message.id =
...
export const QueryResolverResponse = {
  ...
  fromJSON(object: any): QueryResolverResponse {
    return {
      ...
      resolver: isSet(object.resolver)
        ? ResolverInfo.fromJSON(object.resolver)
        : undefined,
    };
  },
  ...
  toJSON(message: QueryResolverResponse): unknown {
    ...
    message.resolver !== undefined &&
      (obj.resolver = message.resolver
        ? ResolverInfo.toJSON(message.resolver)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<QueryResolverResponse>, I>>(
    object: I,
  ): QueryResolverResponse {
    const message = createBaseQueryResolverResponse();
    message.resolver =
...
export const QueryResolversByIRIRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryResolversByIRIRequest>, I>>(
    object: I,
  ): QueryResolversByIRIRequest {
    const message = createBaseQueryResolversByIRIRequest();
    message.iri = object.iri ?? '';
...
messageTypeRegistry.set(
  QueryResolversByIRIRequest.$type,
  QueryResolversByIRIRequest,
);
...
export const QueryResolversByIRIResponse = {
  ...
  fromJSON(object: any): QueryResolversByIRIResponse {
    return {
      ...
      resolvers: Array.isArray(object?.resolvers)
        ? object.resolvers.map((e: any) => ResolverInfo.fromJSON(e))
        : [],
      pagination: isSet(object.pagination)
        ? PageResponse.fromJSON(object.pagination)
        : undefined,
  ...
  toJSON(message: QueryResolversByIRIResponse): unknown {
    ...
    if (message.resolvers) {
      obj.resolvers = message.resolvers.map(e =>
        e ? ResolverInfo.toJSON(e) : undefined,
      );
    } else {
      obj.resolvers = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<QueryResolversByIRIResponse>, I>>(
    object: I,
  ): QueryResolversByIRIResponse {
    const message = createBaseQueryResolversByIRIResponse();
    message.resolvers =
      object.resolvers?.map(e => ResolverInfo.fromPartial(e)) || [];
    message.pagination =
      object.pagination !== undefined && object.pagination !== null
        ? PageResponse.fromPartial(object.pagination)
        : undefined;
...
messageTypeRegistry.set(
  QueryResolversByIRIResponse.$type,
  QueryResolversByIRIResponse,
);
...
export const QueryResolversByHashRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryResolversByHashRequest>, I>>(
    object: I,
  ): QueryResolversByHashRequest {
    const message = createBaseQueryResolversByHashRequest();
    message.contentHash =
...
messageTypeRegistry.set(
  QueryResolversByHashRequest.$type,
  QueryResolversByHashRequest,
);
...
export const QueryResolversByHashResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryResolversByHashResponse>, I>>(
    object: I,
  ): QueryResolversByHashResponse {
    const message = createBaseQueryResolversByHashResponse();
    message.resolvers =
...
messageTypeRegistry.set(
  QueryResolversByHashResponse.$type,
  QueryResolversByHashResponse,
);
...
export const QueryResolversByURLRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryResolversByURLRequest>, I>>(
    object: I,
  ): QueryResolversByURLRequest {
    const message = createBaseQueryResolversByURLRequest();
...
messageTypeRegistry.set(
  QueryResolversByURLRequest.$type,
  QueryResolversByURLRequest,
);
...
export const QueryResolversByURLResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryResolversByURLResponse>, I>>(
    object: I,
  ): QueryResolversByURLResponse {
    const message = createBaseQueryResolversByURLResponse();
    message.resolvers =
...
messageTypeRegistry.set(
  QueryResolversByURLResponse.$type,
  QueryResolversByURLResponse,
);
...
export const ConvertIRIToHashRequest = {
  ...
  fromJSON(object: any): ConvertIRIToHashRequest {
    return {
      $type: ConvertIRIToHashRequest.$type,
      iri: isSet(object.iri) ? String(object.iri) : '',
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ConvertIRIToHashRequest>, I>>(
    object: I,
  ): ConvertIRIToHashRequest {
    const message = createBaseConvertIRIToHashRequest();
    message.iri = object.iri ?? '';
...
export const ConvertIRIToHashResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<ConvertIRIToHashResponse>, I>>(
    object: I,
  ): ConvertIRIToHashResponse {
    const message = createBaseConvertIRIToHashResponse();
    message.contentHash =
...
export const ConvertHashToIRIRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ConvertHashToIRIRequest>, I>>(
    object: I,
  ): ConvertHashToIRIRequest {
    const message = createBaseConvertHashToIRIRequest();
    message.contentHash =
...
export const ConvertHashToIRIResponse = {
  ...
  fromJSON(object: any): ConvertHashToIRIResponse {
    return {
      $type: ConvertHashToIRIResponse.$type,
      iri: isSet(object.iri) ? String(object.iri) : '',
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ConvertHashToIRIResponse>, I>>(
    object: I,
  ): ConvertHashToIRIResponse {
    const message = createBaseConvertHashToIRIResponse();
    message.iri = object.iri ?? '';
...
export const AnchorInfo = {
  ...
  fromPartial<I extends Exact<DeepPartial<AnchorInfo>, I>>(
    object: I,
  ): AnchorInfo {
    const message = createBaseAnchorInfo();
    message.iri = object.iri ?? '';
...
export const AttestationInfo = {
  ...
  fromPartial<I extends Exact<DeepPartial<AttestationInfo>, I>>(
    object: I,
  ): AttestationInfo {
    const message = createBaseAttestationInfo();
    message.iri = object.iri ?? '';
...
export const ResolverInfo = {
  ...
  fromPartial<I extends Exact<DeepPartial<ResolverInfo>, I>>(
    object: I,
  ): ResolverInfo {
    const message = createBaseResolverInfo();
    message.id =
...
export interface Query {
  ...
  AnchorByIRI(
    request: DeepPartial<QueryAnchorByIRIRequest>,
  ): Promise<QueryAnchorByIRIResponse>;
  /** AnchorByHash queries a data anchor by the ContentHash of the data. */
  AnchorByHash(
    request: DeepPartial<QueryAnchorByHashRequest>,
  ): Promise<QueryAnchorByHashResponse>;
  ...
  AttestationsByIRI(
    request: DeepPartial<QueryAttestationsByIRIRequest>,
  ): Promise<QueryAttestationsByIRIResponse>;
  /**
   * AttestationsByHash queries data attestations by the ContentHash of the
   * data.
   */
  AttestationsByHash(
    request: DeepPartial<QueryAttestationsByHashRequest>,
  ): Promise<QueryAttestationsByHashResponse>;
  /** Resolver queries a resolver by its unique identifier. */
  Resolver(
    request: DeepPartial<QueryResolverRequest>,
   ...
   */
  ResolversByIRI(
    request: DeepPartial<QueryResolversByIRIRequest>,
  ): Promise<QueryResolversByIRIResponse>;
  /**
   * ResolversByHash queries resolvers with registered data by the ContentHash
   * of the data.
   */
  ResolversByHash(
    request: DeepPartial<QueryResolversByHashRequest>,
  ): Promise<QueryResolversByHashResponse>;
  /** ResolversByURL queries resolvers by URL. */
  ResolversByURL(
    request: DeepPartial<QueryResolversByURLRequest>,
  ): Promise<QueryResolversByURLResponse>;
  /** ConvertIRIToHash converts an IRI to a ContentHash. */
  ConvertIRIToHash(
    request: DeepPartial<ConvertIRIToHashRequest>,
  ): Promise<ConvertIRIToHashResponse>;
  /** ConvertHashToIRI converts a ContentHash to an IRI. */
  ConvertHashToIRI(
    request: DeepPartial<ConvertHashToIRIRequest>,
  ): Promise<ConvertHashToIRIResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  AnchorByIRI(
    ...
    return promise.then(data =>
      QueryAnchorByIRIResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  AnchorByHash(
    ...
    return promise.then(data =>
      QueryAnchorByHashResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  AttestationsByAttestor(
    ...
    const data =
      QueryAttestationsByAttestorRequest.encode(fromPartial).finish();
    const promise = this.rpc.request(
      'regen.data.v1.Query',
      'AttestationsByAttestor',
      data,
    ...
    return promise.then(data =>
      QueryAttestationsByAttestorResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  AttestationsByIRI(
    ...
    return promise.then(data =>
      QueryAttestationsByIRIResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  AttestationsByHash(
    ...
    return promise.then(data =>
      QueryAttestationsByHashResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  Resolver(
    ...
    return promise.then(data =>
      QueryResolverResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  ResolversByIRI(
    ...
    return promise.then(data =>
      QueryResolversByIRIResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  ResolversByHash(
    ...
    return promise.then(data =>
      QueryResolversByHashResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  ResolversByURL(
    ...
    return promise.then(data =>
      QueryResolversByURLResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  ConvertIRIToHash(
    ...
    return promise.then(data =>
      ConvertIRIToHashResponse.decode(new _m0.Reader(data)),
    );
  }
  ...
  ConvertHashToIRI(
    ...
    return promise.then(data =>
      ConvertHashToIRIResponse.decode(new _m0.Reader(data)),
    );
  }
}
