...
export const MsgAnchor = {
  ...
  create(base?: DeepPartial<MsgAnchor>): MsgAnchor {
    return MsgAnchor.fromPartial(base ?? {});
  },
...
function createBaseMsgAnchorResponse(): MsgAnchorResponse {
  return { $type: "regen.data.v1.MsgAnchorResponse", iri: "", timestamp: undefined };
}
...
export const MsgAnchorResponse = {
  ...
  create(base?: DeepPartial<MsgAnchorResponse>): MsgAnchorResponse {
    return MsgAnchorResponse.fromPartial(base ?? {});
  },
...
export const MsgAttest = {
  ...
  create(base?: DeepPartial<MsgAttest>): MsgAttest {
    return MsgAttest.fromPartial(base ?? {});
  },
...
function createBaseMsgAttestResponse(): MsgAttestResponse {
  return { $type: "regen.data.v1.MsgAttestResponse", iris: [], timestamp: undefined };
}
...
export const MsgAttestResponse = {
  ...
  create(base?: DeepPartial<MsgAttestResponse>): MsgAttestResponse {
    return MsgAttestResponse.fromPartial(base ?? {});
  },
...
export const MsgDefineResolver = {
  ...
  create(base?: DeepPartial<MsgDefineResolver>): MsgDefineResolver {
    return MsgDefineResolver.fromPartial(base ?? {});
  },
...
function createBaseMsgDefineResolverResponse(): MsgDefineResolverResponse {
  return { $type: "regen.data.v1.MsgDefineResolverResponse", resolverId: Long.UZERO };
}
...
export const MsgDefineResolverResponse = {
  ...
  create(base?: DeepPartial<MsgDefineResolverResponse>): MsgDefineResolverResponse {
    return MsgDefineResolverResponse.fromPartial(base ?? {});
  },
...
messageTypeRegistry.set(MsgDefineResolverResponse.$type, MsgDefineResolverResponse);
...
export const MsgRegisterResolver = {
  ...
  create(base?: DeepPartial<MsgRegisterResolver>): MsgRegisterResolver {
    return MsgRegisterResolver.fromPartial(base ?? {});
  },
...
export const MsgRegisterResolverResponse = {
  ...
  fromJSON(_: any): MsgRegisterResolverResponse {
    return { $type: MsgRegisterResolverResponse.$type };
  },
  ...
  create(base?: DeepPartial<MsgRegisterResolverResponse>): MsgRegisterResolverResponse {
    return MsgRegisterResolverResponse.fromPartial(base ?? {});
  },
...
messageTypeRegistry.set(MsgRegisterResolverResponse.$type, MsgRegisterResolverResponse);
...
export interface Msg {
   ...
   */
  DefineResolver(request: DeepPartial<MsgDefineResolver>): Promise<MsgDefineResolverResponse>;
  /** RegisterResolver registers data content hashes */
  RegisterResolver(request: DeepPartial<MsgRegisterResolver>): Promise<MsgRegisterResolverResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || "regen.data.v1.Msg";
    this.rpc = rpc;
  ...
  Anchor(request: DeepPartial<MsgAnchor>): Promise<MsgAnchorResponse> {
    ...
    const promise = this.rpc.request(this.service, "Anchor", data);
  ...
  DefineResolver(request: DeepPartial<MsgDefineResolver>): Promise<MsgDefineResolverResponse> {
    ...
    const promise = this.rpc.request(this.service, "DefineResolver", data);
  ...
  RegisterResolver(request: DeepPartial<MsgRegisterResolver>): Promise<MsgRegisterResolverResponse> {
    ...
    const promise = this.rpc.request(this.service, "RegisterResolver", data);
