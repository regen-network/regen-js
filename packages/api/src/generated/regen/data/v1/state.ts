...
function createBaseDataAnchor(): DataAnchor {
  return { $type: "regen.data.v1.DataAnchor", id: new Uint8Array(), timestamp: undefined };
}
...
export const DataAnchor = {
  ...
  create(base?: DeepPartial<DataAnchor>): DataAnchor {
    return DataAnchor.fromPartial(base ?? {});
  },
...
export const DataAttestor = {
  ...
  toJSON(message: DataAttestor): unknown {
    ...
    message.attestor !== undefined &&
      (obj.attestor = base64FromBytes(message.attestor !== undefined ? message.attestor : new Uint8Array()));
    message.timestamp !== undefined && (obj.timestamp = message.timestamp.toISOString());
    return obj;
  },

  create(base?: DeepPartial<DataAttestor>): DataAttestor {
    return DataAttestor.fromPartial(base ?? {});
  },
...
function createBaseResolver(): Resolver {
  return { $type: "regen.data.v1.Resolver", id: Long.UZERO, url: "", manager: new Uint8Array() };
}
...
export const Resolver = {
  ...
  toJSON(message: Resolver): unknown {
    ...
    message.manager !== undefined &&
      (obj.manager = base64FromBytes(message.manager !== undefined ? message.manager : new Uint8Array()));
    return obj;
  },
...
function createBaseDataResolver(): DataResolver {
  return { $type: "regen.data.v1.DataResolver", id: new Uint8Array(), resolverId: Long.UZERO };
}
...
export const DataResolver = {
  ...
  create(base?: DeepPartial<DataResolver>): DataResolver {
    return DataResolver.fromPartial(base ?? {});
  },
