...
function createBaseCreditType(): CreditType {
  return { $type: "regen.ecocredit.v1alpha1.CreditType", name: "", abbreviation: "", unit: "", precision: 0 };
}
...
function createBaseCreditTypeSeq(): CreditTypeSeq {
  return { $type: "regen.ecocredit.v1alpha1.CreditTypeSeq", abbreviation: "", seqNumber: Long.UZERO };
}
...
export const CreditTypeSeq = {
  ...
  create(base?: DeepPartial<CreditTypeSeq>): CreditTypeSeq {
    return CreditTypeSeq.fromPartial(base ?? {});
  },
