...
function createBaseSoftwareUpgradeProposal(): SoftwareUpgradeProposal {
  return { $type: "cosmos.upgrade.v1beta1.SoftwareUpgradeProposal", title: "", description: "", plan: undefined };
}
...
function createBaseCancelSoftwareUpgradeProposal(): CancelSoftwareUpgradeProposal {
  return { $type: "cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal", title: "", description: "" };
}
...
function createBaseModuleVersion(): ModuleVersion {
  return { $type: "cosmos.upgrade.v1beta1.ModuleVersion", name: "", version: Long.UZERO };
}
