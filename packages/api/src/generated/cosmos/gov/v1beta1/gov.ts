...
export const Proposal = {
  encode(message: Proposal, writer: Writer = Writer.create()): Writer {
    ...
    if (message.finalTallyResult !== undefined && message.finalTallyResult !== undefined) {
      TallyResult.encode(message.finalTallyResult, writer.uint32(34).fork()).ldelim();
    }
    if (message.submitTime !== undefined && message.submitTime !== undefined) {
      Timestamp.encode(toTimestamp(message.submitTime), writer.uint32(42).fork()).ldelim();
    }
    if (message.depositEndTime !== undefined && message.depositEndTime !== undefined) {
      Timestamp.encode(toTimestamp(message.depositEndTime), writer.uint32(50).fork()).ldelim();
    }
    for (const v of message.totalDeposit) {
      Coin.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    if (message.votingStartTime !== undefined && message.votingStartTime !== undefined) {
      Timestamp.encode(toTimestamp(message.votingStartTime), writer.uint32(66).fork()).ldelim();
    }
    if (message.votingEndTime !== undefined && message.votingEndTime !== undefined) {
...
export const DepositParams = {
  encode(message: DepositParams, writer: Writer = Writer.create()): Writer {
    ...
    if (message.maxDepositPeriod !== undefined && message.maxDepositPeriod !== undefined) {
...
export const VotingParams = {
  encode(message: VotingParams, writer: Writer = Writer.create()): Writer {
    if (message.votingPeriod !== undefined && message.votingPeriod !== undefined) {
