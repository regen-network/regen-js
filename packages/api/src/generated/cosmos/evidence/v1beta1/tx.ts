...
function createBaseMsgSubmitEvidence(): MsgSubmitEvidence {
  return { $type: "cosmos.evidence.v1beta1.MsgSubmitEvidence", submitter: "", evidence: undefined };
}
...
function createBaseMsgSubmitEvidenceResponse(): MsgSubmitEvidenceResponse {
  return { $type: "cosmos.evidence.v1beta1.MsgSubmitEvidenceResponse", hash: new Uint8Array() };
}
...
messageTypeRegistry.set(MsgSubmitEvidenceResponse.$type, MsgSubmitEvidenceResponse);
...
export interface Msg {
   ...
   */
  SubmitEvidence(request: DeepPartial<MsgSubmitEvidence>): Promise<MsgSubmitEvidenceResponse>;
}
