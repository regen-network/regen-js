...
function createBaseQueryGrantsResponse(): QueryGrantsResponse {
  return { $type: "cosmos.authz.v1beta1.QueryGrantsResponse", grants: [], pagination: undefined };
}
...
function createBaseQueryGranterGrantsRequest(): QueryGranterGrantsRequest {
  return { $type: "cosmos.authz.v1beta1.QueryGranterGrantsRequest", granter: "", pagination: undefined };
}
...
messageTypeRegistry.set(QueryGranterGrantsRequest.$type, QueryGranterGrantsRequest);

function createBaseQueryGranterGrantsResponse(): QueryGranterGrantsResponse {
  return { $type: "cosmos.authz.v1beta1.QueryGranterGrantsResponse", grants: [], pagination: undefined };
}
...
messageTypeRegistry.set(QueryGranterGrantsResponse.$type, QueryGranterGrantsResponse);

function createBaseQueryGranteeGrantsRequest(): QueryGranteeGrantsRequest {
  return { $type: "cosmos.authz.v1beta1.QueryGranteeGrantsRequest", grantee: "", pagination: undefined };
}
...
messageTypeRegistry.set(QueryGranteeGrantsRequest.$type, QueryGranteeGrantsRequest);

function createBaseQueryGranteeGrantsResponse(): QueryGranteeGrantsResponse {
  return { $type: "cosmos.authz.v1beta1.QueryGranteeGrantsResponse", grants: [], pagination: undefined };
}
...
messageTypeRegistry.set(QueryGranteeGrantsResponse.$type, QueryGranteeGrantsResponse);

/** Query defines the gRPC querier service. */
export interface Query {
  /** Returns list of `Authorization`, granted to the grantee by the granter. */
  Grants(request: DeepPartial<QueryGrantsRequest>): Promise<QueryGrantsResponse>;
  /**
   * GranterGrants returns list of `GrantAuthorization`, granted by granter.
   *
   * Since: cosmos-sdk 0.46
   */
  GranterGrants(request: DeepPartial<QueryGranterGrantsRequest>): Promise<QueryGranterGrantsResponse>;
  /**
   * GranteeGrants returns a list of `GrantAuthorization` by grantee.
   *
   * Since: cosmos-sdk 0.46
   */
  GranteeGrants(request: DeepPartial<QueryGranteeGrantsRequest>): Promise<QueryGranteeGrantsResponse>;
}
