...
export const MsgCreateVestingAccountResponse = {
  ...
  fromJSON(_: any): MsgCreateVestingAccountResponse {
    return { $type: MsgCreateVestingAccountResponse.$type };
  },
...
messageTypeRegistry.set(MsgCreateVestingAccountResponse.$type, MsgCreateVestingAccountResponse);
...
messageTypeRegistry.set(MsgCreatePermanentLockedAccount.$type, MsgCreatePermanentLockedAccount);

function createBaseMsgCreatePermanentLockedAccountResponse(): MsgCreatePermanentLockedAccountResponse {
  return { $type: "cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccountResponse" };
}
...
export const MsgCreatePermanentLockedAccountResponse = {
  ...
  fromJSON(_: any): MsgCreatePermanentLockedAccountResponse {
    return { $type: MsgCreatePermanentLockedAccountResponse.$type };
  },
...
messageTypeRegistry.set(MsgCreatePermanentLockedAccountResponse.$type, MsgCreatePermanentLockedAccountResponse);
...
messageTypeRegistry.set(MsgCreatePeriodicVestingAccount.$type, MsgCreatePeriodicVestingAccount);

function createBaseMsgCreatePeriodicVestingAccountResponse(): MsgCreatePeriodicVestingAccountResponse {
  return { $type: "cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccountResponse" };
}
...
export const MsgCreatePeriodicVestingAccountResponse = {
  ...
  fromJSON(_: any): MsgCreatePeriodicVestingAccountResponse {
    return { $type: MsgCreatePeriodicVestingAccountResponse.$type };
  },
...
messageTypeRegistry.set(MsgCreatePeriodicVestingAccountResponse.$type, MsgCreatePeriodicVestingAccountResponse);
...
export interface Msg {
   ...
   * account.
   */
  CreateVestingAccount(request: DeepPartial<MsgCreateVestingAccount>): Promise<MsgCreateVestingAccountResponse>;
  /**
...
export class MsgClientImpl implements Msg {
  ...
  CreatePeriodicVestingAccount(
    ...
    const fromPartial = MsgCreatePeriodicVestingAccount.fromPartial(request);
    const data = MsgCreatePeriodicVestingAccount.encode(fromPartial).finish();
