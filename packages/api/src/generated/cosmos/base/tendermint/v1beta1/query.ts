...
const baseGetValidatorSetByHeightRequest: object = {
  height: Long.ZERO,
};

const baseGetValidatorSetByHeightResponse: object = {
...
const baseGetLatestValidatorSetResponse: object = {
  blockHeight: Long.ZERO,
};
...
const baseGetBlockByHeightRequest: object = {
  height: Long.ZERO,
};
...
const baseGetSyncingResponse: object = {
  syncing: false,
};
...
export const GetValidatorSetByHeightRequest = {
  encode(message: GetValidatorSetByHeightRequest, writer: Writer = Writer.create()): Writer {
...
export const GetValidatorSetByHeightResponse = {
  encode(message: GetValidatorSetByHeightResponse, writer: Writer = Writer.create()): Writer {
...
export const GetLatestValidatorSetRequest = {
  encode(message: GetLatestValidatorSetRequest, writer: Writer = Writer.create()): Writer {
    if (message.pagination !== undefined && message.pagination !== undefined) {
...
export const GetLatestValidatorSetResponse = {
  encode(message: GetLatestValidatorSetResponse, writer: Writer = Writer.create()): Writer {
    writer.uint32(8).int64(message.blockHeight);
    for (const v of message.validators) {
      Validator.encode(v!, writer.uint32(18).fork()).ldelim();
    }
...
export const GetBlockByHeightRequest = {
  encode(message: GetBlockByHeightRequest, writer: Writer = Writer.create()): Writer {
    writer.uint32(8).int64(message.height);
    return writer;
  },
  decode(input: Uint8Array | Reader, length?: number): GetBlockByHeightRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetBlockByHeightResponse = {
  encode(message: GetBlockByHeightResponse, writer: Writer = Writer.create()): Writer {
...
export const GetLatestBlockResponse = {
  encode(message: GetLatestBlockResponse, writer: Writer = Writer.create()): Writer {
    if (message.blockId !== undefined && message.blockId !== undefined) {
      BlockID.encode(message.blockId, writer.uint32(10).fork()).ldelim();
    }
    if (message.block !== undefined && message.block !== undefined) {
...
export const GetSyncingResponse = {
  encode(message: GetSyncingResponse, writer: Writer = Writer.create()): Writer {
...
export const GetNodeInfoResponse = {
  encode(message: GetNodeInfoResponse, writer: Writer = Writer.create()): Writer {
    if (message.defaultNodeInfo !== undefined && message.defaultNodeInfo !== undefined) {
      DefaultNodeInfo.encode(message.defaultNodeInfo, writer.uint32(10).fork()).ldelim();
    }
    if (message.applicationVersion !== undefined && message.applicationVersion !== undefined) {
