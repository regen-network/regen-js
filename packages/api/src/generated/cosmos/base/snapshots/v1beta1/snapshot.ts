...
export const SnapshotStoreItem = {
  ...
  fromJSON(object: any): SnapshotStoreItem {
    return { $type: SnapshotStoreItem.$type, name: isSet(object.name) ? String(object.name) : "" };
  },
...
function createBaseSnapshotExtensionMeta(): SnapshotExtensionMeta {
  return { $type: "cosmos.base.snapshots.v1beta1.SnapshotExtensionMeta", name: "", format: 0 };
}
...
function createBaseSnapshotExtensionPayload(): SnapshotExtensionPayload {
  return { $type: "cosmos.base.snapshots.v1beta1.SnapshotExtensionPayload", payload: new Uint8Array() };
}
...
messageTypeRegistry.set(SnapshotExtensionPayload.$type, SnapshotExtensionPayload);

function createBaseSnapshotKVItem(): SnapshotKVItem {
  return { $type: "cosmos.base.snapshots.v1beta1.SnapshotKVItem", key: new Uint8Array(), value: new Uint8Array() };
}
