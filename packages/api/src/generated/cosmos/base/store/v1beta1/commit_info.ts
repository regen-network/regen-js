...
function createBaseCommitInfo(): CommitInfo {
  return { $type: "cosmos.base.store.v1beta1.CommitInfo", version: Long.ZERO, storeInfos: [] };
}
...
function createBaseStoreInfo(): StoreInfo {
  return { $type: "cosmos.base.store.v1beta1.StoreInfo", name: "", commitId: undefined };
}
...
function createBaseCommitID(): CommitID {
  return { $type: "cosmos.base.store.v1beta1.CommitID", version: Long.ZERO, hash: new Uint8Array() };
}
