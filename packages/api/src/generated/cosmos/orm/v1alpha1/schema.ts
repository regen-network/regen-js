...
function createBaseModuleSchemaDescriptor(): ModuleSchemaDescriptor {
  return { $type: "cosmos.orm.v1alpha1.ModuleSchemaDescriptor", schemaFile: [], prefix: new Uint8Array() };
}
...
function createBaseModuleSchemaDescriptor_FileEntry(): ModuleSchemaDescriptor_FileEntry {
  return { $type: "cosmos.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry", id: 0, protoFileName: "", storageType: 0 };
}
...
messageTypeRegistry.set(ModuleSchemaDescriptor_FileEntry.$type, ModuleSchemaDescriptor_FileEntry);
