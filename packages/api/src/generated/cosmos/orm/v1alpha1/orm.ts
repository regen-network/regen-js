...
export interface TableDescriptor {
  $type: 'cosmos.orm.v1alpha1.TableDescriptor';
...
export interface PrimaryKeyDescriptor {
  $type: 'cosmos.orm.v1alpha1.PrimaryKeyDescriptor';
  /**
...
export interface SecondaryIndexDescriptor {
  $type: 'cosmos.orm.v1alpha1.SecondaryIndexDescriptor';
  /**
...
export interface SingletonDescriptor {
  $type: 'cosmos.orm.v1alpha1.SingletonDescriptor';
  /**
   * id is a non-zero integer ID that must be unique within the
   * tables and singletons in this file. It may be deprecated in the future when this
   * can be auto-generated.
...
export const TableDescriptor = {
  $type: 'cosmos.orm.v1alpha1.TableDescriptor' as const,
...
export const PrimaryKeyDescriptor = {
  $type: 'cosmos.orm.v1alpha1.PrimaryKeyDescriptor' as const,
...
export const SecondaryIndexDescriptor = {
  $type: 'cosmos.orm.v1alpha1.SecondaryIndexDescriptor' as const,
...
function createBaseSingletonDescriptor(): SingletonDescriptor {
  return { $type: 'cosmos.orm.v1alpha1.SingletonDescriptor', id: 0 };
}

export const SingletonDescriptor = {
  $type: 'cosmos.orm.v1alpha1.SingletonDescriptor' as const,
