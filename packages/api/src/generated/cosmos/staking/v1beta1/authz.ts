...
function createBaseStakeAuthorization_Validators(): StakeAuthorization_Validators {
  return { $type: "cosmos.staking.v1beta1.StakeAuthorization.Validators", address: [] };
}
...
messageTypeRegistry.set(StakeAuthorization_Validators.$type, StakeAuthorization_Validators);
