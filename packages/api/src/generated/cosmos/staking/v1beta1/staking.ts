...
function createBaseHistoricalInfo(): HistoricalInfo {
  return { $type: "cosmos.staking.v1beta1.HistoricalInfo", header: undefined, valset: [] };
}
...
function createBaseCommissionRates(): CommissionRates {
  return { $type: "cosmos.staking.v1beta1.CommissionRates", rate: "", maxRate: "", maxChangeRate: "" };
}
...
function createBaseCommission(): Commission {
  return { $type: "cosmos.staking.v1beta1.Commission", commissionRates: undefined, updateTime: undefined };
}
...
function createBaseDVPair(): DVPair {
  return { $type: "cosmos.staking.v1beta1.DVPair", delegatorAddress: "", validatorAddress: "" };
}
...
function createBaseDelegation(): Delegation {
  return { $type: "cosmos.staking.v1beta1.Delegation", delegatorAddress: "", validatorAddress: "", shares: "" };
}
...
messageTypeRegistry.set(UnbondingDelegationEntry.$type, UnbondingDelegationEntry);
...
function createBaseDelegationResponse(): DelegationResponse {
  return { $type: "cosmos.staking.v1beta1.DelegationResponse", delegation: undefined, balance: undefined };
}
...
function createBaseRedelegationEntryResponse(): RedelegationEntryResponse {
  return { $type: "cosmos.staking.v1beta1.RedelegationEntryResponse", redelegationEntry: undefined, balance: "" };
}
...
messageTypeRegistry.set(RedelegationEntryResponse.$type, RedelegationEntryResponse);

function createBaseRedelegationResponse(): RedelegationResponse {
  return { $type: "cosmos.staking.v1beta1.RedelegationResponse", redelegation: undefined, entries: [] };
}
...
function createBasePool(): Pool {
  return { $type: "cosmos.staking.v1beta1.Pool", notBondedTokens: "", bondedTokens: "" };
}
