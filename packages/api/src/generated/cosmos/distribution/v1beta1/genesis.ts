...
const baseValidatorOutstandingRewardsRecord: object = {
  validatorAddress: "",
};
...
const baseValidatorCurrentRewardsRecord: object = {
  validatorAddress: "",
};
...
export const ValidatorAccumulatedCommissionRecord = {
  encode(message: ValidatorAccumulatedCommissionRecord, writer: Writer = Writer.create()): Writer {
    writer.uint32(10).string(message.validatorAddress);
    if (message.accumulated !== undefined && message.accumulated !== undefined) {
...
export const DelegatorStartingInfoRecord = {
  encode(message: DelegatorStartingInfoRecord, writer: Writer = Writer.create()): Writer {
    ...
    if (message.startingInfo !== undefined && message.startingInfo !== undefined) {
...
export const ValidatorSlashEventRecord = {
  encode(message: ValidatorSlashEventRecord, writer: Writer = Writer.create()): Writer {
    ...
    if (message.validatorSlashEvent !== undefined && message.validatorSlashEvent !== undefined) {
...
export const GenesisState = {
  encode(message: GenesisState, writer: Writer = Writer.create()): Writer {
    ...
    if (message.feePool !== undefined && message.feePool !== undefined) {
