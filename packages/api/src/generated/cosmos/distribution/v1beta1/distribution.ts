...
messageTypeRegistry.set(ValidatorHistoricalRewards.$type, ValidatorHistoricalRewards);

function createBaseValidatorCurrentRewards(): ValidatorCurrentRewards {
  return { $type: "cosmos.distribution.v1beta1.ValidatorCurrentRewards", rewards: [], period: Long.UZERO };
}
...
function createBaseValidatorAccumulatedCommission(): ValidatorAccumulatedCommission {
  return { $type: "cosmos.distribution.v1beta1.ValidatorAccumulatedCommission", commission: [] };
}
...
messageTypeRegistry.set(ValidatorAccumulatedCommission.$type, ValidatorAccumulatedCommission);

function createBaseValidatorOutstandingRewards(): ValidatorOutstandingRewards {
  return { $type: "cosmos.distribution.v1beta1.ValidatorOutstandingRewards", rewards: [] };
}
...
messageTypeRegistry.set(ValidatorOutstandingRewards.$type, ValidatorOutstandingRewards);

function createBaseValidatorSlashEvent(): ValidatorSlashEvent {
  return { $type: "cosmos.distribution.v1beta1.ValidatorSlashEvent", validatorPeriod: Long.UZERO, fraction: "" };
}
...
function createBaseValidatorSlashEvents(): ValidatorSlashEvents {
  return { $type: "cosmos.distribution.v1beta1.ValidatorSlashEvents", validatorSlashEvents: [] };
}
...
messageTypeRegistry.set(CommunityPoolSpendProposal.$type, CommunityPoolSpendProposal);
...
function createBaseDelegationDelegatorReward(): DelegationDelegatorReward {
  return { $type: "cosmos.distribution.v1beta1.DelegationDelegatorReward", validatorAddress: "", reward: [] };
}
...
messageTypeRegistry.set(DelegationDelegatorReward.$type, DelegationDelegatorReward);
...
messageTypeRegistry.set(CommunityPoolSpendProposalWithDeposit.$type, CommunityPoolSpendProposalWithDeposit);
