...
function createBaseQueryParamsResponse(): QueryParamsResponse {
  return { $type: "cosmos.slashing.v1beta1.QueryParamsResponse", params: undefined };
}
...
function createBaseQuerySigningInfoRequest(): QuerySigningInfoRequest {
  return { $type: "cosmos.slashing.v1beta1.QuerySigningInfoRequest", consAddress: "" };
}
...
function createBaseQuerySigningInfoResponse(): QuerySigningInfoResponse {
  return { $type: "cosmos.slashing.v1beta1.QuerySigningInfoResponse", valSigningInfo: undefined };
}
...
messageTypeRegistry.set(QuerySigningInfoResponse.$type, QuerySigningInfoResponse);

function createBaseQuerySigningInfosRequest(): QuerySigningInfosRequest {
  return { $type: "cosmos.slashing.v1beta1.QuerySigningInfosRequest", pagination: undefined };
}
...
messageTypeRegistry.set(QuerySigningInfosRequest.$type, QuerySigningInfosRequest);

function createBaseQuerySigningInfosResponse(): QuerySigningInfosResponse {
  return { $type: "cosmos.slashing.v1beta1.QuerySigningInfosResponse", info: [], pagination: undefined };
}
...
messageTypeRegistry.set(QuerySigningInfosResponse.$type, QuerySigningInfosResponse);
...
export interface Query {
  ...
  SigningInfo(request: DeepPartial<QuerySigningInfoRequest>): Promise<QuerySigningInfoResponse>;
  /** SigningInfos queries signing info of all validators */
  SigningInfos(request: DeepPartial<QuerySigningInfosRequest>): Promise<QuerySigningInfosResponse>;
}
