...
function createBaseGenesisState(): GenesisState {
  return { $type: "cosmos.slashing.v1beta1.GenesisState", params: undefined, signingInfos: [], missedBlocks: [] };
}
...
function createBaseSigningInfo(): SigningInfo {
  return { $type: "cosmos.slashing.v1beta1.SigningInfo", address: "", validatorSigningInfo: undefined };
}
...
function createBaseValidatorMissedBlocks(): ValidatorMissedBlocks {
  return { $type: "cosmos.slashing.v1beta1.ValidatorMissedBlocks", address: "", missedBlocks: [] };
}
...
function createBaseMissedBlock(): MissedBlock {
  return { $type: "cosmos.slashing.v1beta1.MissedBlock", index: Long.ZERO, missed: false };
}
